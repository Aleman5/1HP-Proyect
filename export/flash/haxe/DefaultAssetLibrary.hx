...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_theme_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_death_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_colespadas_wav extends flash.media.Sound { }
